...
Steps:
First, you will have to log in Visual Studio C# 2010 Express.
Once you have save the file from the link given, you will need to go to HitThatBalloon_game > WindowsGame1> WindowsGame1 > Game1.cs
In Game1.cs, you might be able to click on "Start Debugging" due to the Read-Only setting.
I would suggest you to copy the code and paste in a new file.
